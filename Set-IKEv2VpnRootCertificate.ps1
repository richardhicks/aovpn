...
.SYNOPSIS
    Configures the trusted root certification authority to be used for devic based IKEv2 VPN connections on Windows Server Routing and Remote Access Service (RRAS) servers.

.PARAMETER Thumbprint
    Certificate thumbprint of the trusted root certification authority used for devic based IKEv2 VPN connections.

.PARAMETER EnableCertificateAuthentication
    Enables machine certificate authentication for devic based IKEv2 VPN connections.
...
.EXAMPLE
    ...
    Running this command will configure RRAS to use this certification authority as the exclusive trusted CA for all devic based IKEv2 VPN connections.
    
.EXAMPLE
    .\Set-IKEv2VPNRootCertificate.ps1 -Thumbprint '71899A67BF33AF31BEFDC071F8F733B183856332' -EnableCertificateAuthentication

    Running this command will configure RRAS to use this certification authority as the exclusive trusted CA for all deviced-based IKEv2 VPN connections. Including the -EnableCertificateAuthentication switch will automatically add Certificate authentication to the list of accepted user authentication protocols (prerequisite for setting root CA cert).

.DESCRIPTION
    Use this script to configure the trusted root certification authority for devic based IKEv2 VPN connections.
...
Set-VpnAuthProtocol -UserAuthProtocolAccepted $Protocols -RootCertificateNameToAccept $RootCACert
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUaLBuDai6X6SedCcv6YlcdKvt
# 4HygghTlMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# TkM/kTdWteqVQrY+2PedCm5WqhAwDQYJKoZIhvcNAQEBBQAEggEAn3YE20wsuxgv
# eGshQ/mIrE4X062dir4becJbfUgNdsvTRwZ5uJ9RnLZpz9/TpNlY6he5Zfm3UOEt
# 4IgGfEqs2uFXelvvF2lvWnmrrQ2veFK84rAqdkzMlpl4iuxYv0vRHmp3upVyw7w6
# Sfdd+U+pp0chYbEd6a1qqqwlOea/1QCZ2jTNETCxo++X0lnflKPWXucLr0FnjhzR
# mytcj/J3tOmIK2b2ctSy5nddah0qydKJbJiL/Hq0PTzkYOLi3zZapdwcV8J3MAyZ
# IRbK5czttIT8duUtOxQBnpLxE1GILQi+k4DF23sRb9zY00APOKyReUuLHyBeFWnM
# Ek+ZaTIMHKGCAjAwggIsBgkqhkiG9w0BCQYxggIdMIICGQIBATCBhjByMQswCQYD
...
# GAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjEwNjA0
# MjAxMTA2WjAvBgkqhkiG9w0BCQQxIgQg2CYq17XvWxb/LQE08pIvYsH3F2r8jE6J
# lXAn2WKF5xswDQYJKoZIhvcNAQEBBQAEggEAcZCE/7r6vtpwpURKXLOyh8hUsQCI
# RQINb6Ep4ZDeneSnz4DuvDtSdt+zglYSya2C6890wUBLiioSZepw7WozcfPC1vWD
# Ge1ATj28Bl6bx7eIxw85TYG7OhaBEcJo763kQFDfpoRBTKDE5y94e2QvHUQwpmak
# 2VvRNTq/sp+8TTCZJdzubLx0nAYa1EWDED0U4DQUdvW8Q3B5aZZEQ5lRq5GyrlyV
# agxOjMWqpZnb2Sa43VgKyMAnd+RHdQHG90KOpqGUd++3yfJBWuOJO3+XoiX7rMjF
# 2kHjabP++1Tc+RucPgIzHrJFFe5VbnIFPWGYtq6QgnwuV5cr6Qrvv5UiHA==
