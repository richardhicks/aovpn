...
If ($OSVersion -Like '6.*') {
    ...
    If ($Performance) {
        ...
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P256,TLS_RSA_WITH_AES_128_GCM_SHA256'
    ...
    If ($Security) {
        ...
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384_P384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_P256,TLS_RSA_WITH_AES_256_GCM_SHA384,TLS_RSA_WITH_AES_128_GCM_SHA256'
...
If ($OSVersion -Like '*14393*' -or $OSVersion -Like '*17134 *') {
    ...
    If ($Performance) {
        ...
        Write-Verbose 'Using performance optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_128_GCM_SHA256'
    ...
    If ($Security) {
        ...
        Write-Verbose 'Using security optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_256_GCM_SHA384,TLS_RSA_WITH_AES_128_GCM_SHA256'
...
If ($OSVersion -Like '*20329*' -or $OSVersion -Like '*17763*' -or $OSVersion -Like '*18363*' -or $OSVersion -Like '*18362*') {
    ...
    If ($Performance) {
        ...
        Write-Verbose 'Using performance optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_AES_128_GCM_SHA256,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_128_GCM_SHA256'
    ...
    If ($Security) {
        ...
        Write-Verbose 'Using security optimized TLS configuration.'
        $CipherSuiteOrder = 'TLS_AES_256_GCM_SHA384,TLS_AES_128_GCM_SHA256,TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,TLS_RSA_WITH_AES_256_GCM_SHA384,TLS_RSA_WITH_AES_128_GCM_SHA256'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUagBFVF/tGeRkXoWyhDN5XoUG
# 8C2gghTlMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# PrCsD8uT9wgsQJ/vPhcC5GH4su4wDQYJKoZIhvcNAQEBBQAEggEAMGhfdzK1hwho
# WT40RRKDf4nOeDgwH6v3LXkWuSpjnvB4h/C9PrB0hyOskrF2Lt26vkrvAjZ0x3gx
# bedWYPtzUKiL+r4jXmpfKIVQEdPjZwz2YS1xBGGgboWJesf9zB1/rQPeH3gSH/YS
# 3erirKl+Qihvxvq5douzGZw2E2LV54MGhCI9vmDlciyZ1wrQO0HsZDeLfq/Rzz2W
# I3YXWC+siyP7jbktFHrHgjYnyqaXwbmmpJ7Si/aKC5Y9lSkPRDhDbiCaPa/dMTNm
# xWpeKdCreejjK8/tAc172/HV0SLvryelxVxrefIKDOfXVryzAtOmDxjsPDv1KpLX
# T1DfwmWMkKGCAjAwggIsBgkqhkiG9w0BCQYxggIdMIICGQIBATCBhjByMQswCQYD
...
# GAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjEwNjEw
# MjMzMjA2WjAvBgkqhkiG9w0BCQQxIgQgSFP9ZG+3ISo3NRb1ZNFNH2J8/A2r2D0H
# pwuQNTyf/a8wDQYJKoZIhvcNAQEBBQAEggEAi30Hmjvgb/lX+/ABpgHEEfXfjp7g
# pK6XGK7ohVgR97F0ZwoszaZhqpSWXcNUzeWIMmI+9DXXpY3SIexCE7BUtVhO1BAZ
# jm+WuvG4DTDjJ9bz/JwlakXCCc/V1e5NKHFAOYa8LPWV4x57ujitkdzPZGGPEntK
# FqdegsRkbc/Gy8EiSGuVRPkEzs413kRWFIp6Fq6/KVvCJlnmUwM3kC5UBENiJKgl
# ANFlbo8EVPIXMSEn+74Wy2HzPTbwUCq+7mXc4EphN2IF+Ytz33UfStj5A1NWQs4H
# 8buoNvP8yYyK3y3HJH134fbnegMHRGHhBt5grGndhPOURuhtpTIn/3ma1w==
