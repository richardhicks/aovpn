...
.EXAMPLE
    .\Remove-VpnConnections -ConnectionAge 2D
...
Param (
    ...
    [ValidateSet("8 Hours", "1 Day", "2 Days", "3 Days", "4 Days", "5 Days", "1 Week")]
    [string]$ConnectionAge = '1 Day'
...
Switch ($ConnectionAge) {
    ...
    '3 Days' { $Seconds = '259200' }
    '4 Days' { $Seconds = '345600' }
    '5 Days' { $Seconds = '432000' }
    '1 Week' { $Seconds = '604800' }
...
If ($null -eq $Connections) {
    ...
    Write-Warning "No connections exceeding $Seconds seconds. Exiting script."
    Exit
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUnPRLvGk8unbUXGbvaPwJ9dko
# /legghTlMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# RFX/ESGf7sJaLEHJxgJTA4SMbIkwDQYJKoZIhvcNAQEBBQAEggEAVsRXy4rykRXU
# Jib7LpPQXaGsmE0AHLv1OLjqlOWaadmgjuXls05b4XsX3CZ2BfYK2iJrfUd4qeNe
# 7DVNcHsfj9sIyjl9hPk4EYZAuNU+RLgHER/9LpnRf/aDmRsWVCEoyYJj5gLnvtdK
# NdR07SynfcKrSx8+9eeWaGKy1xlPlMb1ss6Lnkq0PJmv1LDl21kTwrYHkUvFVm6r
# ahk4K8das22CjxVMNk/dasDNLzJFQ1AdNq9//I1l/1oLdvS8Ih3O9KNnxhRYvxkE
# mdukUS2PedcWPHnEdTHGhFcux3Uo4yXUpW5NQnWBSqCc0m/1FI64xmjyyWf5qDUg
# tB0zs9UvMKGCAjAwggIsBgkqhkiG9w0BCQYxggIdMIICGQIBATCBhjByMQswCQYD
...
# MjAyNzA4WjAvBgkqhkiG9w0BCQQxIgQgiZkDk+hSKVrk0zQkLokNxn0QBATgw4Wi
# GkPUQ7hWiQIwDQYJKoZIhvcNAQEBBQAEggEAvGMdmetSuUBJ2TZ5/dmolMOhC3YH
# Yb1Rx2ZFyr7uA4yxE6beRzbq+IUUaZ/Vqto+fM3HOc7IRerWeGwkavAgHUGCWk8A
# jqgWC4x7WTsRFhWMjDBjaUHcy1j9R/FcORwnUNx2wT+tMPZrPHu0ou36hAzss9Zl
# QkvvocSoGirhHuS8Ju9Thi9XViKIeZfDH1fjyK4gklAwejYdluvDJnwa+X7SCrNS
# kH7XsxBBzj2P26DnBiY4IJAxDM+OucNGTtqsPOay9/+m6lqcOyEf1cEh5IpDLf0k
# xBP6htQ54Q5HHstJd3e7acuh7k/MqHBuWMeic05mHGbAoo+/7sV/jjUAJw==
