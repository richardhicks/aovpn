...
.SYNOPSIS
    Install the Windows 10 Enterprise Edition KMS client setup key.

.EXAMPLE
    .\Install-EnterpriseKMSClientSetupKey.ps1

.DESCRIPTION
    Script used to convert non-Enterprise Edition versions of Windows 10 to Enterprise Edition. This is required to support Always On VPN device tunnel for Autopilot and hybrid Azure AD join scenarios.
...
If ($Edition -NotLike '*Enterprise*') {
    ...
    Write-Verbose 'Enterprise Edition not detected. Installing Enterprise KMS client setup key...'
    Invoke-Command -ScriptBlock {cscript.exe c:\windows\system32\slmgr.vbs /ipk NPPR9-FWDCX-D2C8J-H872K-2YT43} | Out-Null

    # // Restart network interfaces to ensure device tunnel starts
    Write-Verbose 'Restarting network adapters...'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVYcKBhT/G4OUAvlpR8hpYxn0
# dgegghTlMIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHOFADw3TANBgkqhkiG9w0B
...
# ekrI1yP8oWlxiAUbVBDHsaoWFtQwDQYJKoZIhvcNAQEBBQAEggEAQ/wOI5OQkB4g
# tjTbEpT9a0GMkTBU2GLVA0BxNoRfmVE5INVUPaRtXMb6P8v8GsDSkc1meg6cvdei
# 6oMaQ0gb1kczZf01BH+By1KXgFSvcYUZcqPD3Am6/BGkHhduocqmK5ooVqOW00U9
# AS4uMlboznU+O4apb5MRQ8ZaRqF4F+xmuhgjOJqlRUcoOn7lieQXeahxLW1Zx8ix
# ehpEcCZ1j/40SLpbCXA+x4ksIcXsQgoerbinpZaWjlsOaiA00MVap8q4pkILBkuu
# Ine/jWKa+ss7vW+uE8BokTzyTGIPDkH6fnB8G2ugvZ6St+fxJ2ICFljQSZI5uUGf
# HwcfzIZSnqGCAjAwggIsBgkqhkiG9w0BCQYxggIdMIICGQIBATCBhjByMQswCQYD
...
# MTkxMTEwWjAvBgkqhkiG9w0BCQQxIgQgvQ5IbUuFwzm/n26e6wX/bf9OR/ST+RYi
# BCAQaaEQI1wwDQYJKoZIhvcNAQEBBQAEggEAE7w5Qu/Uev/I1Aw1Ibq4V4nVqomO
# C5rCVrK86n4X43RmkDqgP6xVLhP7jqyxsbBEKIJe8ucer69s+/arVAlnQ/wfAgnk
# IxtT/IvsllVa655+pQvX0/fX/E8GjwqASrfApnA5QmjmWxOhLccmxAQrozO4UHrD
# EkuSUDIG4vBTiqu8Ol2yNbpE5xqKrLowdJjepgpen667PxaisY8XXcDqaZqZ9W4a
# XhJbg/6ASzfxQoofKG2JluRgtGO1SJZcynFx16d//dFEU1a4HHXopO+dHyKAuqkh
# Iytv/W4DB4wMtRzWxga0kDMh/WtLoQ5ypFPwRF8GtwG8jo5xUsHcPfa3Jg==
