...
.PARAMETER EnableInboxAccounting
    Use this parameter to configure inbox accounting for remote access.
...
.EXAMPLE
    .\Install-VpnServerBaselineConfiguration.ps1 -EnableInboxAccounting

    Installs the DirectAccess-VPN role and configure remote access to support VPN connections and configures inbox accounting.
...
# // Enable inbox accounting (optional but recommended)
If ($EnableInboxAccounting) {
    
Write-Verbose 'Enabling Remote Access inbox accounting...'
Set-RemoteAccessAccounting -EnableAccountingType Inbox -PassThru
Write-Warning 'Run Optimize-InboxAccountingDatabase.ps1 to ensure optimal performance on this server. Details here: https://rmhci.co/30mRlO5.'

}

Write-Verbose 'VPN server baseline configuration complete.'

# SIG # Begin signature block
# MIINbAYJKoZIhvcNAQcCoIINXTCCDVkCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULy1G3vMYXKqVFm7CL4XTCq/B
# 3omgggquMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBAHtcb7Mk7sQHXAypMQy0BmXxiIMA0G
# CSqGSIb3DQEBAQUABIIBAJEq7+PCyWkuTuZco7VaU0WtpEyL5N1z9rhhS+vBxFzv
# 9O1/CXdwqMpI7jrlK70hJ3pJtAvtjdtHCaxcPmQYq0NYCRn4VIpb7AQ3hH7A9Wo8
# 066GIF0cG9saa7XpD0T0CbQT3H+d1cKxj/cJNU28mcUyM2UX5oEEoVeCGZtGKpxx
# qX4VYDgruAb4trk5VqqHNXy6WHUm+OvVfcecqCpeW/houP13E52HDEDurBT9ILUM
# PRV4Y8YlyGXgMz4hXdZypL9U00BnzuxMTpNqf7WccNdbWPTwmu/pbzYutpLKwLpv
# r9F8UsdankScXR1OBRjpgQ/JnPrHtIUulFQA/h+eWh0=
