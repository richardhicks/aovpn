...
.PARAMETER Reset
    Resets the VPN server's IKEv2 security parameters to their default settings.
...
If ($Reset) {
    ...
    If ($Restart) {
        ...
        Write-Verbose 'Restarting the ResmoteAccess service...'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUOQVwBBugtaYMRACeQKFYwE3B
# 01WgggquMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOf4Dv4/YBr6jvq6IKNLfMGcwPrEMA0G
# CSqGSIb3DQEBAQUABIIBAFCOP+z9HfVxpWRAHR8ECLS+/IGFWk4QLyETtLX/Vucs
# t4Ri5jTosfpFuaODGrXrIjl5RJw729ihEGETBvNtA/8N4n7K2T2a/DHfwOSLH1HE
# c7juD8y7qkHir/mfOs+5j8BA3AQKqggmbeeRmjtC/qD5wSwwfCujSgeawO5d/Q4p
# OA7aaZ8a3+ofD1X+8WmKPuQoOMuuea+j3zRyxeH3/R31noVCkeOaJgEdg9wShX2/
# 65TtsF/aoosnwpg9q/zev2yrIS8zCSY1xwsnXIRZ5qNfcVRnWc9ric8ORaz+ASpH
# 9nr1sauL0pmC45iwvMLjdsnGBB5vy76W5U+uonLhqu4=
